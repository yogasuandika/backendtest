$(function () {
    ...
    $("#datalist").tabulator({
        ...
        columns: [
            {title: "ID", field: "id", width: 100, headerFilter: "input", sorter: "number", headerFilterPlaceholder: " "},
            {title: "Name", field: "name", width: 250, headerFilter: "input", headerFilterPlaceholder: " "},
            {title: "Email", field: "email", width: 200, headerFilter: "input", headerFilterPlaceholder: " "},
            {title: "Postcode", field: "postcode", width: 200, headerFilter: "input", headerFilterPlaceholder: " "},
            {title: "Prefecture", 
                    field: "display_name", 
                    width: 200, 
                    headerFilter:"select", 
            ...
            {title: "Updated At", field: "updated_at", width: 250, headerFilter: "input", headerFilterPlaceholder: " "},
...
function PageDataInfo(data){
    ...
    $('#datalist-total-data').val(getDataCount);
