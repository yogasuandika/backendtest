...
Route::GROUP(['middleware' => ['auth:user']], function() {
    ...
    //Company
    Route::GET('/companies', 'Backend\CompanyController@index')->name('company.list');
    Route::GET('/companies/add', 'Backend\CompanyController@add')->name('company.add');
    Route::GET('autocomplete', 'Backend\CompanyController@autocomplete')->name('autocomplete');
    Route::POST('/companies/create', 'Backend\CompanyController@store')->name('company.create');
    Route::GET('/companies/edit/{id}', 'Backend\CompanyController@edit')->name('company.edit');
    Route::POST('/companies/update', 'Backend\CompanyController@update')->name('company.update');
    Route::GET('/companies/delete', 'Backend\CompanyController@delete')->name('company.delete');
