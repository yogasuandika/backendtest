        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Company Add Page</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    @if ($errors->any())
                    ...
                    @endif
                    <form method="POST" action="{{ route('company.create') }}" role="form" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div id="form-streetaddress" class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-10 col-content">
                        {{ Form::text('streetaddress', $company->streetaddress, array('placeholder' => '', 'class' => 'form-control validate[required, maxSize[100]]', 'data-prompt-position' => 'bottomLeft:0,11')) }}
                        </div>
                    </div>
                    ...
                    <div id="form-businesshour" class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-10 col-content">
                        {{ Form::text('businesshour', $company->businesshour, array('placeholder' => '', 'class' => 'form-control validate[required, maxSize[100]]', 'data-prompt-position' => 'bottomLeft:0,11')) }}
                        </div>
                    </div>
                    ...
                    <div id="form-regularholiday" class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-10 col-content">
                        {{ Form::text('regularholiday', $company->regularholiday, array('placeholder' => '', 'class' => 'form-control validate[required, maxSize[100]]', 'data-prompt-position' => 'bottomLeft:0,11')) }}
                        </div>
                    </div>
                    ...
                    <div id="form-licensenumber" class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-10 col-content">
                        {{ Form::text('licensenumber', $company->licensenumber, array('placeholder' => '', 'class' => 'form-control validate[required, maxSize[100]]', 'data-prompt-position' => 'bottomLeft:0,11')) }}
                        </div>
                    </div>
                    ...
                    <div id="form-img" class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-10 col-content">
                        {{ Form::file('image', $company->image, array('placeholder' => '','id' =>'image', 'class' => 'form-control validate[required, maxSize[5000]]', 'data-prompt-position' => 'bottomLeft:0,11')) }}
